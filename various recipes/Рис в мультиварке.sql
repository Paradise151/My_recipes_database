...
VALUES
(
(SELECT recipe_id FROM recipe WHERE name_recipe = 'Рис в мультиварке'),  -- recipe_id
(SELECT ingredient_id FROM ingredient WHERE name_ingredient  = 'Рис'),  -- ingredient_id
1,  -- pieces
0.350,  -- weight_kg
(SELECT step_id  
 FROM step 
