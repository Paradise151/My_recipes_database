...
VALUES
(
(SELECT recipe_id FROM recipe WHERE name_recipe = 'Перловка в мультиварке'),  -- recipe_id
(SELECT ingredient_id FROM ingredient WHERE name_ingredient  = 'Перловка'),  -- ingredient_id
1,  -- pieces
0.350,  -- weight_kg
(SELECT step_id  
 FROM step 
